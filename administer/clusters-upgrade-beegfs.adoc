...
NOTE: 如果要升级到 BeeGFS v8，请参见link:clusters-upgrade-beegfs-v8.html["升级到 BeeGFS v8"]过程。
...
| 7.4.6 | 8.0 | 是的。 | 使用link:clusters-upgrade-beegfs-v8.html["升级到 BeeGFS v8"]过程中的说明进行升级。 


| 7.4.6 | 8.1 | 是的。 | 使用link:clusters-upgrade-beegfs-v8.html["升级到 BeeGFS v8"]过程中的说明进行升级。 


| 7.4.6 | 8.2 | 是的。 | 使用link:clusters-upgrade-beegfs-v8.html["升级到 BeeGFS v8"]过程中的说明进行升级。 
|===
