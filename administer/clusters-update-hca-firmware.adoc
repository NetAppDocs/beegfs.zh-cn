...
NOTE: 某些固件更新可能需要重新启动才能应用更新。有关指导，请参阅 link:https://networking-docs.nvidia.com/mftswum/4201/mlxfwreset-loading-firmware-on-5th-generation-devices-tool#id-(4.20.1)mlxfwreset–LoadingFirmwareon5thGenerationDevicesTool-mlxfwresetLimitations["NVIDIA的mxfwreset限制"^]。如果需要重新启动，请执行重新启动，而不是重置适配器。
