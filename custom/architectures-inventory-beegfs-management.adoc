...
----
单击 link:https://github.com/NetApp/beegfs/blob/master/getting_started/beegfs_on_netapp/gen2/H2_DAC_IB_A2_EF600/beegfs_cluster_building_blocks/beegfs_ha_building_block_cluster_1/group_vars/mgmt.yml["此处"^] 以查看表示 BeeGFS 管理服务的完整库存文件示例。
